...
<div id="authTabs">
	...
	<div id="register">
		<div class="error">Something went wrong with creating your account...please try again? There's a good chance that someone else had the name and, as this is an alpha, that error isn't being caught correctly (or at all)</div>
