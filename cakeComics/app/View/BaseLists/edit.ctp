<div class="baseLists form">
<?php echo $this->Form->create('BaseList');?>
	<fieldset>
		<legend><?php echo __('Edit Base List'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('BaseList.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('BaseList.id'))); ?></li>
